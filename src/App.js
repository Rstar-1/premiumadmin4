...
const  App = () => {
  return (
    <div className="App relative">
      <Router>
        <div className="flex gap-9 bg-e8f2fc h-100 prpx20 ptpx20 plpx20 relative overflow-hidden ">
          <div className="w-side z-10">
            <Sidebar />
          </div>
          <div className="w-route z-10">
            <Header />
            <Routes>
          ...
          <div className="absolute top-0 left-0 w-full bgprimary p70"></div>
        </div>
      </Router>
    </div>
  );
